import { createFileRoute, lazyRouteComponent, redirect, createRootRoute, Outlet, HeadContent, Scripts, RouterProvider, createRouter as createRouter$1 } from '@tanstack/react-router';
import { jsx, jsxs } from 'react/jsx-runtime';
import { createEnv } from '@t3-oss/env-core';
import * as v from 'valibot';
import { pipe, string, trim, regex } from 'valibot';
import ky from 'ky';
  ...
  return createServerFnStaticCache({
    getItem: async (ctx) => {
      if (typeof document === "undefined") {
        ...
        const publicUrl = "/Users/odeschenes/Documents/git/championsmastery.lol/start/.output/public";
        const {
          promises: fs
...
async function loadVirtualModule(id) {
  switch (id) {
    ...
    case VIRTUAL_MODULES.startManifest:
      return await import('./_tanstack-start-manifest_v-DL6FH1we.mjs');
    case VIRTUAL_MODULES.serverFnManifest:
      return await import('./_tanstack-start-server-fn-manifest_v-CQlJ824x.mjs');
    default:
...
const handleServerAction = async ({
  ...
  const regex2 = new RegExp(`${sanitizeBase$1("/_serverFn")}/([^/?#]+)`);
  const match = url.pathname.match(regex2);
...
const appCss = "/assets/app-DaQmmNvX.css";
...
function RootDocument({
  ...
  return /* @__PURE__ */ jsxs("html", { children: [
    ...
    /* @__PURE__ */ jsxs("body", { className: "w-screen h-screen flex dark bg-neutral-950 text-white justify-center items-center", children: [
      children,
      /* @__PURE__ */ jsx(Scripts, {})
    ] })
  ] });
}
const $$splitComponentImporter$2 = () => import('./index-DJT6k4V_.mjs');
const Route$2 = createFileRoute("/")({
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitComponentImporter$1 = () => import('./index-BznG2aHl.mjs');
const Route$1 = createFileRoute("/lol/summoner/")({
  ...
  ensureRateLimit(endpoint) {
    ...
    for (const limit of config.limits) {
      ...
      if (requestsInWindow >= limit.requests) {
        const windowSeconds = limit.windowMs / 1e3;
...
function parseRateLime(rateLimitStr) {
  const [requests, timeWindowStr] = rateLimitStr.split(" requests every ");
  return {
    requests: Number(requests),
    windowMs: parseTimeWindow(timeWindowStr)
  };
}
function parseTimeWindow(timeStr) {
...
pipe(string(), trim(), regex(/.*#.*/));
const AccountDTOSchema = v.object({
  puuid: v.string(),
  gameName: v.string(),
  tagLine: v.string()
});
const AccountRegionDTOSchema = v.object({
  puuid: v.string(),
  game: v.picklist(["lol", "tft"]),
  region: v.picklist(LolRegions)
});
new ApiRoute({
  getUrl: (params) => `https://${params.routingValue}.api.riotgames.com/riot/account/v1/region/by-game/lol/by-puuid/${params.puuid}`,
...
const AcountV1ByRiotID = new ApiRoute({
  getUrl: (params) => `https://${params.routingValue}.api.riotgames.com/riot/account/v1/accounts/by-riot-id/${params.gameName}/${params.tagLine}`,
  key: `account-v1-by-riot-id"`,
  limits: [parseRateLime("1000 requests every 1 minutes")],
  schema: AccountDTOSchema
});
new ApiRoute({
  getUrl: (params) => `https://${params.routingValue}.api.riotgames.com/riot/account/v1/accounts/by-puuid/${params.puuid}`,
  key: `account-v1-by-puuid`,
  limits: [parseRateLime("1000 requests every 1 minutes")],
  schema: AccountDTOSchema
});
new ApiRoute({
  getUrl: (params) => `https://${params.routingValue}.api.riotgames.com/riot/account/v1/accounts/me`,
...
const $$splitComponentImporter = () => import('./_riotID-D9qiIfY2.mjs');
const Route = createFileRoute("/lol/summoner/$riotID")({
  component: lazyRouteComponent($$splitComponentImporter, "component"),
  loader: async (ctx) => await $getSummonerByRiotID({
...
const LolSummonerIndexRoute = Route$1.update({
  id: "/lol/summoner/",
  path: "/lol/summoner/",
  getParentRoute: () => Route$3
});
const LolSummonerRiotIDRoute = Route.update({
...
const rootRouteChildren = {
  IndexRoute,
  LolSummonerRiotIDRoute,
  LolSummonerIndexRoute
};
...
export { AcountV1ByRiotID as A, Route$2 as R, Route as a, createServerFn as b, createServerRpc as c, serverEntry as default };
